<?php /*{!! Html::style('lobibox/font-awesome/css/font-awesome.min.css') !!}
 {!! Html::style('lobibox/dist/css/lobibox.min.css') !!}
 {!! Html::script('lobibox/lib/jquery.1.11.min.js') !!} 
{!! Html::script('lobibox/js/lobibox.js') !!}
<?php /* {!! Html::script('lobibox/demo/demo.js') !!} */ ?>
{!! Html::style('public/lobibox/dist/css/lobibox.min.css') !!}
{!! Html::script('public/lobibox/lib/jquery.1.11.min.js') !!} 
{!! Html::script('public/lobibox/js/lobibox.js') !!}
@if(isset($errors))
    @if ($errors->any())
        <script>
         $(function () {
