  <header class="main-header">
    ...
    <a href="javascript:;" class="logo">
      ...
      <span class="logo-mini"><b>Q</b>Z</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Qashu</b>Quiz</span>
    </a>
    <!-- Header Navbar -->
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  {{ucwords(Auth::user()->name)}} - {{ucwords(Auth::user()->roles[0]->name)}}
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="{{route('users.edit',Auth::user()->username)}}" class="btn btn-default btn-flat">Profile</a>
                </div>
