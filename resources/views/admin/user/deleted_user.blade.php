...
@section('title', " ".trans('menu.sidebar.users.deleted')." - " .app_name(). " :: Admin")
@section('content')
    <section class="content-header">
      ...
      <ol class="breadcrumb">
         ...
         <li class="active">{{trans('menu.sidebar.users.deleted')}}</li>
         @else
         <li class="active">{{trans('menu.sidebar.users.deleted')}}</li>
         @endif
      </ol>
    ...
    <section class="content">
      <div class="box box-success">
        <div class="box-header with-border">
          <h3 class="box-title">{{trans('menu.sidebar.users.deleted')}}</h3>
  ...
  jQuery(document).ready(function() {
    jQuery('#data_filter').dataTable({
      sPaginationType: "full_numbers",
       processing: true,
        serverSide: true,
        ajax: '{!! route('deleted-users.ajax.data') !!}',
        columns: [
