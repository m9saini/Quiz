      ...
      <div class="box box-success">
        <div class="box-header with-border">
          ...
          <div class="box-tools pull-right">
            ...
            <a href="{{route('permission.create')}}" class="btn btn-success btn-sm pull-right "><i class="fa fa-refresh"></i>&nbsp;&nbsp;{{trans('menu.sidebar.permission.refresh')}}</a>
          </div>
        </div>
...
<script>
  jQuery(document).ready(function() {
    jQuery('#data_filter').dataTable({
      ...
      processing: true,
        serverSide: true,
        ajax: '{!! route('permission.ajax.data') !!}',
        columns: [            
