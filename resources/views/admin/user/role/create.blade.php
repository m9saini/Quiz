...
@section('title', " ".trans('menu.sidebar.role.create')." - " .app_name(). " :: Admin")
@section('content')
    <section class="content-header">
      ...
      <ol class="breadcrumb">
         ...
         <li class="active">{{trans('menu.sidebar.role.create')}}</li>
      </ol>
    </section>
    <section class="content">
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">{{trans('menu.sidebar.role.create')}}</h3>
        ...
        <div class="box-body">
          <div class="row">
               <div class="col-md-12">
                  {!! Form::open(['route' => 'roles.store','class'=>'form-horizontal','id'=>'validateForm']) !!}
                    <div class="row">
                       <div class="form-group col-sm-12">
                          <label class="col-sm-2 control-label">{{trans('menu.sidebar.role.form.name')}} <span class="asterisk">*</span></label>
                          <div class="col-sm-10">
                             <input class="form-control "  name="name" required  title="Please enter role name." value="{{ old('name') }}"  id="name" placeholder="Role Name" type="text">
