...
@section('title', " ".trans('menu.sidebar.users.activated')." - " .app_name(). " :: Admin")
@section('content')
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="{{route('backend.dashboard')}}">{{trans('menu.sidebar.dashboard')}}</a></li>
         ...
         <li class="active">{{trans('menu.sidebar.users.activated')}}</li>
         @else
         <li class="active">{{trans('menu.sidebar.users.activated')}}</li>
         @endif
      </ol>
    ...
    <section class="content">
      <div class="box box-success">
        <div class="box-header with-border">
          <h3 class="box-title">{{trans('menu.sidebar.users.activated')}}</h3>
  ...
  jQuery(document).ready(function() {
    jQuery('#data_filter').dataTable({
      sPaginationType: "full_numbers",
       processing: true,
        serverSide: true,
        ajax: '{!! route('activated-users.ajax.data',["role"=>$role]) !!}',
        columns: [
