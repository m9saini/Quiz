                                ...
                                <table id="top-bar" class="w640" bgcolor="#ffffff"  border="0" cellpadding="0" cellspacing="0" width="640" style="background-position: 0 100px; height: 80px;overflow:hidden;">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="w325" style="background: #ffffff;" align="left" valign="middle">
                                                <h1 style="color: rgb(255, 255, 255); vertical-align:middle; margin:0px; padding:0px;">
                                                    <img  style="margin-left: 10px;" align='left' src="{{url('images/logo.png')}}" width="250" alt="{{env('APP_NAME', '')}}" />
                                                </h1>
                                            </td>
                                        </tr>
                                    </tbody>
                                ...
                                <table class="w640" border="0" cellpadding="0" cellspacing="0" width="640">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="w580" width="580"  style="word-break: break-all;">{!! $content !!}</td>
                                            <td class="w30" width="30"></td>
                                        </tr>
                                    </tbody>
                                </table>                  
