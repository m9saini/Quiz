 <div class="panel-body">
   ...
   <div class="form-group">
      <label class="col-sm-2 control-label">{{trans($model.'::menu.sidebar.form.meta_keyword')}} <span class="asterisk">*</span></label>
      <div class="col-sm-10">
         {{ Form::text('meta_keyword',null, ['required','class'=>'form-control','id'=>'meta_keyword','placeholder'=>'Meta Keyword','title'=>'Please enter meta keyword.']) }}
      </div>
   </div>   
   <div class="form-group">
      <label class="col-sm-2 control-label">{{trans($model.'::menu.sidebar.form.meta_description')}} <span class="asterisk">*</span></label>
      <div class="col-sm-10">
         {{ Form::text('meta_description',null, ['required','class'=>'form-control','id'=>'meta_description','placeholder'=>'Meta description','title'=>'Please enter meta description.','rows'=>'5']) }}
      </div>
   </div>
   <div class="form-group">
      <label class="col-sm-2 control-label">{{trans($model.'::menu.sidebar.form.description')}} <span class="asterisk">*</span></label>
      <div class="col-sm-10 ">
        <span class="err_editor"> {{ Form::textarea("description", null, ['required','class' => 'form-control', 'id'=>'ckeditor','rows'=>'10', 'title'=>"Please enter desctiption.",'placeholder'=>"message"]) }}
        </span>
      </div>
   </div>
   <div class="form-group">
      <label class="col-sm-2 control-label">{{trans($model.'::menu.sidebar.form.banner_image')}}</label>
      <div class="col-sm-10">
      <input type="file" name="banner_image" id="mediaId" accept="image/*" @if(isset($data)) value="{{$data->picture_path}}" @endif onchange="after_logo_select(this.id)"  style="display:none" class="form-control">
            <div class="input-group">
                <input type="text" value="@if(isset($data->banner_image)) {{$data->banner_image}} @endif" readonly="" id="logo-duplicate" aria-describedby="basic-addon2" class="form-control">
